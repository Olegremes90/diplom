...
class Machine(models.Model):
    ...
    service_model = models.ForeignKey(Service, on_delete=models.CASCADE,  null=True)
...
class Complaint(models.Model):
    ...
    @property
    def downtime(self):
        return (self.date_recovery - self.date_refusal)/60/60/24
